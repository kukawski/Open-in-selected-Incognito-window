(async function () {
    document.querySelector('form').addEventListener('change', (event) => {
        browser.storage.local.set({
            ...
            excludeCurrentWindow: document.getElementById('excludeCurrentWindow').checked
        });
    });
    ...
    document.getElementById('excludeCurrentWindow').checked = userSettings.excludeCurrentWindow;
}());
